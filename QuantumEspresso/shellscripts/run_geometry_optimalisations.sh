...
SCRIPT="/Users/famkepotze/Desktop/3S/NV-center-3S/QuantumEspresso/scripts/2.geometry_optimalisation.py"
...
do
    ...
    OUTPUT="$BASE/results/optimized_tot_charge-1/NV_${i}x${i}x${i}.json"
